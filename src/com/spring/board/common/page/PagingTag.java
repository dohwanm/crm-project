...
public class PagingTag extends TagSupport {
	 ...
	 * @param page_size 페이지 네비게이터에 표시되는 페잊 ㅣ버튼의 개수
	 * */
	...
	public String getPaging(){
		System.out.println("PagingTag.getPaging()함수 시작");
		...
		if(page > 1){
			...
			ret += "<span><img src='../images/common/btn_paginate_first.gif' alt='처음'/></span>";//"처음><
		}
		...
		if (nextFirst <= lastPage){
			ret += " <a href=\"javascript:goPage('"+nextFirst+"')\"><span><img src='../images/common/btn_paginate_next.gif' alt='다음'/></sapn></a>";
		}else{
		...
		System.out.println("PagingTag.getPaging()함수 끝");
		return ret;
